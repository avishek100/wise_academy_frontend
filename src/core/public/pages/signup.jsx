        ...
        <div className="flex h-screen">
            ...
            <div className="w-1/2 bg-white flex flex-col justify-center px-16">
                <form className="w-3/4 max-w-md">
                    ...
                    {/* Social Login */}
                    <div className="mt-4">
                        <p className="text-center text-sm text-black mb-2">Or sign up with</p>
                        <div className="flex justify-center gap-4">
                            <button className="flex items-center gap-2 px-4 py-2 border rounded-lg text-black hover:bg-blue-500">
